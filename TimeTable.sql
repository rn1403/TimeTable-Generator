...
insert into courses values(2,'AJ');
insert into courses values(3,'MCA');
insert into courses values(4,'BCT');
insert into courses values(5,'DC');
insert into courses values(6,'EC');
insert into courses values(7,'NSS');
insert into courses values(8,'SPOS');
...
/*Teache*/
insert into teach values(1,'SE'),(2,'CNS'),(3,'DBMS'),(4,'FLAT'),(5,'PE-1'),(5,'CSD Coding'),(6,'OE-1'),(7,'IDE-1'),(8,'CSD(q/v)');
/*Teache ended*/
